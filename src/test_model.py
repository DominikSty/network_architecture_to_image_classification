...
class DrawingApp:
    def __init__(self, root):
        ...
        self.canvas = tk.Canvas(self.root, width=BOARD_SIZE * PIXEL_SIZE, height=BOARD_SIZE * PIXEL_SIZE, bg='black')
        self.canvas.pack()
        ...
        self.info_label1 = tk.Label(self.root, text="Program przeznaczony do testowania modelu sieci do rozpoznawania obrazów", fg="black", font=("Arial", 11))
        self.info_label1.place(x=10, y=10)
        self.info_label2 = tk.Label(self.root, text="liczb, czarno-biały obraz w rozdzielczości 28x28 pikseli poddawany jest predykcji", fg="black", font=("Arial", 11))
        self.info_label2.place(x=10, y=30)
        self.info_label3 = tk.Label(self.root, text="na wyuczonym modelu i zwraca przewidywaną wartość. Poniżej znaduje się płutno, ", fg="black", font=("Arial", 11))
        self.info_label3.place(x=10, y=50)
        self.info_label4 = tk.Label(self.root, text="na którym PPM można narysować własną liczbę do sprawdzenia.", fg="black", font=("Arial", 11))
